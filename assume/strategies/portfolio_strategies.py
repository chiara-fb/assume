...
class CournotPortfolioStrategy(UnitOperatorStrategy):
    ...
    and the final markup depends on bidding parameter `cournot_markup` and on 
    the total capacity of the unit operator.
    """

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.cournot_markup = kwargs.get("cournot_markup", 0)
