...
class PortfolioRLStrategy(BaseLearningStrategy, UnitOperatorStrategy):
    ...
    Actions are: 1 price for inflexible generation and act_dim-1 prices for flexible generation. Actions are rescaled 
    ...
    **kwargs : Arbitrary keyword arguments.
    ...
    def get_actions(self, next_observation:th.Tensor) -> tuple[th.Tensor, th.Tensor]:
        ...
        tuple of torch.Tensor
            ...
            The output action has the structure: [inflex_price, flex_prices] where inflex_price is an int representing a single
            price for inflexible generation, and flex_price a list of (self.act_dim - 1) price flexible generation. 
        ...
        price around zero to explore its vicinity. This assumes the last self.act_dim + 1 elements of`next_observation`
        ...
        if self.learning_mode and not self.evaluation_mode:
            if self.collect_initial_experience_mode:
                ...
                individual_obs = next_observation[-(self.act_dim+1):]
    ...
    def get_individual_observations(
        ...
        in range [-1,1] with the structure: [quant_inflex, quant_flex, cost],
        where:
            scaled_quant_inflex: total inflexible capacity
            scaled_quant_flex: total flexible capacity
            scaled_cost: (self.act_dim - 1) quantiles of flex marginal costs.
        ...
        Notes
        -----
            Quantities are scaled min-max scaled by [0, self.installed_capacity].
